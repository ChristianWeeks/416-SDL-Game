...
public:
  ...
  std::vector<Frame*> getBackLayers(const std::string&);
...
private:
  ...
  //contains all images for the backgrounds
  std::map<std::string, std::vector<SDL_Surface*> > backgroundSurfaces;
  std::map<std::string, std::vector<Frame*> > backgroundFrames;
